...
const CACHE_NAME = CACHE_PREFIX + "20260907-3";
const APP_SHELL = ["./", "./index.html", "./styles.css?v=23.3", "./model.js?v=23.3",
  "./chart-export.js?v=23.3", "./app.js?v=23.3", "./manifest.webmanifest", "./icons/icon.svg",
